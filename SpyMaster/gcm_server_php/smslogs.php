...
<html>
    ...
    <body>
        ...
        <input type="button " class="btn btn-primary " onclick="tableToExcel('testTable', 'Spy Call Logs')" value="Export SMS Logs to Excel">
        ...
        $result = $db->getAllSMSRecords($_SESSION['phone']);
        if ($result != false)
        ...
        ?>
        <br/>
        <span class="label label-important">Total SMS records found <?php echo $no_of_records ?></span>
        <fieldset>
                ...
                <table id ="testTable" class="table table-bordered " style="display: none;" >
                    <tr class="success">
                        ...
                        <dl class="dl-horizontal">
                            ...
                            <dd><?php echo $row["number"] ?></dd>
                            <dt><span class="label label-warning">Contact Name</span></dt>
                            <dd><?php echo $row["person"] ?></dd>
                            <dt><span class="label label-warning">SMS Date</span></dt>
                            <dd><?php echo $row["smsdate"] ?></dd>
                            <dt><span class="label label-warning">SMS Type </span></dt>
                            <dd><?php echo $row["smstype"] ?></dd>
                            <dt><span class="label label-warning">SMS Body</span></dt>
                            <dd><?php echo $row["smsbody"] ?></dd>
                        </dl>
                        <tr>
                            <td><?php echo $row["number"] ?></td>
                            <td><?php echo $row["person"] ?></td>
                            <td><?php echo $row["smsdate"] ?></td>
                            <td><?php echo $row["smstype"] ?></td>
                            <td><?php echo $row["smsbody"] ?></td>
